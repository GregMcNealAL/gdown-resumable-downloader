...
Small python script I made to download large files from google drive using gdown (https://github.com/wkentaro/gdown) because downloading via broswer is slow and often crashes. Just paste a share link (must be accessible to anyone with link) and output file name.

## What script does
- Converts a shareable Google Drive link to a direct download link
